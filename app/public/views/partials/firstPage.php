...
<head>
  ...
  <title>Rosa Nails & Spa - Home</title>
  <!-- Link to your CSS file -->
  <link rel="stylesheet" type="text/css" href="../../assets/css/firstPage.css" />
</head>
<body>
  <!-- Navigation Bar -->
  ...
  <section class="banner">
    <!-- Replace this image URL with your own banner image -->
    <img 
  ...
  <section class="gallery">
    ...
    <div class="gallery-container">
      ...
      <div class="service-item">
        ...
        <img
          src="../../img/Acrylic.avif"
          alt="Manicure"
          class="service-image"
        />
        <h3>Acrylic Aftergels</h3>
        <p>
        With acrylic nails, your nails are formed with layers of artificial nails. These stay beautiful and can be finished with all kinds of nail art.
        </p>
      </div>
      <!-- Service Item 2 -->
      <div class="service-item">
        <img
          src="../../img/Pedicure&Medicure.avif"
          alt="Pedicure"
          class="service-image"
        />
        <h3>Pedicure & Medicure</h3>
        <p>
        Let your hands and feet shine again with a manicure or pedicure treatment and finish it off with a beautiful gel polish. During the pedicure you can also enjoy a nice massage.
        </p>
      </div>
      <!-- Service Item 3 -->
      <div class="service-item">
        ...
        <h3>Biab</h3>
        <p>
        Gives your nails a firming gel layer. This is applied to your own nails and gives your nails a beautiful natural color.
        </p>
      </div>
      <!-- Service Item 4 -->
      <div class="service-item">
        ...
        <h3>Gellak</h3>
        <p>
        This is a gel-based varnish. This polish stays in place for 2 to 3 weeks without peeling off.
        </p>
      </div>
    </div>
  </section>

<!-- Price List Section with Navigation -->
<section class="price-list-section">
  <h2>Our Price List</h2>

  <!-- Service Categories Navigation Bar -->
